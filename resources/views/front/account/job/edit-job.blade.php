                        ...
                        <div class="card-body card-form p-4">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select class="form-select" name="jobtype" id="jobtype">
                                        ...
                                        <option {{ $job->job_type == $jobtype->id ? 'selected' : '' }} value="{{ $jobtype->id }}">{{ $jobtype->name }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                    <p></p>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="experience" id="experience" class="form-control">
                                    ...
                                    <option value="10 plus"{{ $job->experience == '10 plus' ? 'selected' : '' }}>10+ Years</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input value="{{ $job->comapny_website }}" type="text" placeholder="Website" id="company_website" name="company_website" class="form-control">
                            </div>
                        </div> 
